...
send "echo '=== ИСПРАВЛЕНИЕ NGINX ПОРТА ==='\r"
expect "=== ИСПРАВЛЕНИЕ NGINX ПОРТА ==="
send "sed -i 's/proxy_pass http:\\/\\/127\\.0\\.0\\.1:8080/proxy_pass http:\\/\\/127\\.0\\.0\\.1:3011/g' /etc/nginx/sites-available/excursionapp\r"
expect "root@hiplet-41895:/opt/birdwatching#"
send "echo '=== ПРОВЕРКА ИЗМЕНЕНИЙ ==='\r"
expect "=== ПРОВЕРКА ИЗМЕНЕНИЙ ==="
send "grep -A 5 -B 5 'proxy_pass.*3011' /etc/nginx/sites-available/excursionapp\r"
expect "root@hiplet-41895:/opt/birdwatching#"
